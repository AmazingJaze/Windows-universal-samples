    ...
    function pinTiles() {
        ...
        try {
            ...
            if (checkBoxSquare150x150Logo.checked) {
                tile.visualElements.square150x150Logo = new Uri("ms-appx:///images/DefaultSecondaryTileAssests/Medium.png");
            }
            if (checkBoxSquare71x71Logo.checked) {
                tile.visualElements.square71x71Logo = new Uri("ms-appx:///images/DefaultSecondaryTileAssests/Small.png");
            }
            if (checkBoxWide310x150Logo.checked) {
                tile.visualElements.wide310x150Logo = new Uri("ms-appx:///images/DefaultSecondaryTileAssests/Wide.png");
            }
